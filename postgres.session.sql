...
/*
5. Find the skills which are the most high paying on average and most demanded 
for the remote working data analyst.
*/

WITH jobs_popularity AS (
    SELECT
        skills_dim.skill_id,
        skills_dim.skills,
        COUNT(skills_job_dim.job_id) AS demand_count
...
SELECT 
    jobs_popularity.skill_id,
    jobs_popularity.skills,
    demand_count,
    avg_salary
FROM jobs_popularity 
INNER JOIN jobs_salaries ON jobs_salaries.skill_id = jobs_popularity.skill_id
